...
@Component({
  selector: 'app-dashboard-hotelier-report',
  templateUrl: './dashboard-hotelier-report.component.html',
  styleUrls: ['./dashboard-hotelier-report.component.css']
})
export class DashboardHotelierReportComponent implements OnInit, OnDestroy {
